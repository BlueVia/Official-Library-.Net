...
{
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <copyright file="Example_MMS_Notifications.cs" company="Telefónica R&D">GNU LPL v3.</copyright>
    /// <summary> MMS Notification's api example.</summary>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    class Example_MMS_Notifications : IExample
    {
        ...
        public void call(String consumer, String ckey, String token, String secret)
        {
            ...
            BV_MOMMS client = new BV_MOMMS(BVMode.SANDBOX, consumer, ckey);
            ...
            try
            {
                ...
                /*Showing Response*/
                Console.WriteLine("\nThe response from Bluevia for the Example_MMS_Notifications when subscribing is:\n");
                ...
                /*Showing Response*/
                Console.WriteLine("\nThe response from Bluevia for the Example_MMS_Notifications when unsubscribing is:\n");
                Console.WriteLine(unsusbscribe);
            }
            catch (BlueviaException e)
            {

                Console.WriteLine("\nExample_MMS_Notifications has failed:\n");
