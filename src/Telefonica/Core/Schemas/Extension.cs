...
namespace Bluevia.Core
{
    ...
    public static class Extension
    {
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Creates a Bluevia.Core.Schemas.MIMEContent from an attachment response. </summary>
        /// <remarks>   13/12/2011. </remarks>
        /// <param name="response"> the response stream from server. </param>
        ...
        public static Bluevia.Core.Schemas.MIMEContent ParseAttachment(this DotNetOpenAuth.Messaging.IncomingWebResponse response)
        {
            ...
            mime.ContentType = response.ContentType;
            mime.Name = response.ContentType.Name;
            if (response.ContentEncoding != null)
            {
                mime.Encoding = response.ContentEncoding;
            }
            else
            {
                mime.Encoding = response.ContentType.CharSet;
            }
            ...
            using (var reader = response.GetResponseReader())
            {
                ...
                //From body content -> attachment data
                while (!reader.EndOfStream) // read until end
                {
        ...
        internal static MultipartPostPart SetAttachmentAsXml (object entity, Type type)
        {
            ...
            post.PartHeaders.Add("Content-Type", "application/xml;charset=UTF-8");
        ...
        internal static MultipartPostPart SetAttachmentAsXml(string filePath, string mimeType)
        {
			...
			if (mimeType == Bluevia.MMS.Schemas.MMSContentTypes.plain)
            {//Attachment is text/plain
                //Saving to a String the text with the apropiate encoding
                StreamReader reader = new StreamReader(filePath, Encoding.Default);
                String codedString = reader.ReadToEnd();
                //Encoding into UTF8 (GetBytes encodes into utf8)
                post.Content = new System.IO.MemoryStream(GetBytes(codedString));
            }
            else
            {//Attachment no text/plain
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /// <returns>   A MIMEContent object. </returns>
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        public static List<Bluevia.Core.Schemas.MIMEContent> ParseAttachments(string text, string bound)
        {
