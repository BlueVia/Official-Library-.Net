...
namespace Bluevia.Core
{
    ...
    public class ServiceBuilder : IServiceBuilder
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary> decides if the content must be buildt in xml</summary>
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Deserialize an error, and returns a RestClient exception, in BlueviaException shape.
        /// This exceptions contains an CLient or Server exception with the error message from the server.</summary>
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        /// <summary>   Returns the access token from the core </summary>
        /// <returns>   The access token in String format. </returns>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void Call()
        {
            ...
            try
            {
                ...
                {
                    BlueviaException ex =  ParseError(response);
                    throw ex;
                }
            }
