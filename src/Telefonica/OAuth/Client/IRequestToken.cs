...
namespace Bluevia.OAuth.Client
{
    public interface IRequestToken
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        Bluevia.Core.Schemas.OAuthToken Get(string callbackUrl = "oob");
        ...
        /// <returns>   Request Token. </returns>
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        Bluevia.Core.Schemas.OAuthToken Get(Payment.Schemas.PaymentInfoType paymentInfo, OAuth.Schemas.ServiceInfo serviceInfo, string callbackUrl = "oob");
    }
}
