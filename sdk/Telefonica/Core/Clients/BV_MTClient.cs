...
{
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <copyright file="BV_MTClient.cs" company="Telefonica R&D">GNU LPL v3.</copyright>
    /// <summary>Abstract client interface for the REST binding of the Bluevia Messagery MO (MobileOriginated)
    /// Service.</summary>
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    public class BV_MTClient :BV_BaseClient
    {
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /// Then concatenates itself the MT string in the service url.</summary>
        /// <param name="mode"> The Bluevia Mode enumerator, that describes the 
        /// operational behavior of the client: <a href="http://www.void.com"> LIVE, TEST, SANDBOX.</a></param>
            ...
            , string certPath, string certPasswd = "")
        {
            ...
            url = string.Format(url, Messagery.Constants.serviceMT);
        }
