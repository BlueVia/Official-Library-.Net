...
{
    class Example_Directory_Terminal : Example
    {
        public string getDescription()
        {
            return ("This Example retrieves Directory terminal Info from Bluevia,\n" +
        ...
        public void call()
        {
            ...
            try
            {
                //REQUESTING DIRECTORY TERMINAL INFO
                var response = authenticatedRequest.Directory.TerminalInfo.Get();


                /*Showing Response*/
                Console.WriteLine("The response from Bluevia for the Example_Directory_Terminal is:\n");
                Console.WriteLine("Any: " + response.Any[0].InnerText + "\n");
                Console.WriteLine("Brand: " + response.brand + "\n");
            ...
            catch (RestClientException e)
            {
                ...
                Console.WriteLine("Example_Directory_Terminal has failed:\n");
