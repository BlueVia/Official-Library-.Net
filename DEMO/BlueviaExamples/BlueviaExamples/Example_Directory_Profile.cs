...
{
    class Example_Directory_Profile : Example
    {
        public string getDescription()
        {
            return ("This Example retrieves Directory profile Info from Bluevia,\n" +
        ...
        public void call()
        {
            ...
            try
            {
                //REQUESTIG DIRECTORY PROFILE INFO
                var response = authenticatedRequest.Directory.ProfileInfo.Get();


                /*Showing Response*/
                Console.WriteLine("The response from Bluevia for the Example_Directory_Profile is:\n");
                Console.WriteLine("Any: " + response.Any[0].InnerText + "\n");
                Console.WriteLine("IMSI: " + response.imsi + "\n");
            ...
            catch (RestClientException e)
            {
                ...
                Console.WriteLine("Example_Directory_Profile has failed:\n");
